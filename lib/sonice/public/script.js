...
$(function() {
  ...
  $('#remote-control nav').on('dragstart', function (e) {

      var node = $(this);

      var evt = retrieveBrowserEvents(e);
      ...
      console.log('offsetX:dragstart', (drag_params.offsetX - evt.clientX));
      console.log('offsetY:dragstart', (drag_params.offsetY - evt.clientY));

      evt.dataTransfer.setData("text/plain", (drag_params.offsetX - evt.clientX) + ','
          + (drag_params.offsetY - evt.clientY));
  ...
  $(document).on('drop', function (e) {
      ...
      var node = $('#remote-control nav');

      /*For debugging purposes*/
      console.log('offsetX: ', parseInt(offset[0],10)) ;
      console.log('offsetY: ', parseInt(offset[1],10)) ;

      node.css({
           left: (parseInt(offset[0], 10) + event.clientX) + 'px',
           top: (parseInt(offset[1], 10) + event.clientY) + 'px'
      });
  ...
  function retrieveBrowserEvents(e) {
